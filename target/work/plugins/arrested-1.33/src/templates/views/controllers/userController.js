...
$rootScope.signup = function () {
    ...
    'save' , username
    :\$rootScope.user.username, passwordHash
    :\$rootScope.user.passwordHash, passwordConfirm
    :\$rootScope.user.passwordConfirm
},
\
$rootScope.loadingSite = true,
    function (result) {
...
$rootScope.login = function () {
    \$rootScope.errors.errorMessages = [];
    DAO.save({appName: \$rootScope.appConfig.appName, controller
    :
    'auth', action
    :
    'login', username
    :\$rootScope.user.username, passwordHash
    :\$rootScope.user.passwordHash
},
\
$rootScope.loadingSite = true,
    function (result) {
