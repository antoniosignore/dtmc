...
(function () {
    var t, e, i, s, l = [].indexOf || function (t) {
    ...
    jQuery.fn.extend({imagepicker: function (e) {
        return null == e && (e = {}), this.each(function () {
            var i;
            return i = jQuery(this), i.next("ul.image_picker_selector").remove(), i.data("picker", new t(this, s(e))), null != e.initialized ? e.initialized() : void 0
        })
    }}), s = function (t) {
        var e;
        ...
        function t(t, e) {
            this.opts = null != e ? e : {}, this.select = jQuery(t), this.multiple = "multiple" === this.select.attr("multiple"), null != this.select.data("limit") && (this.opts.limit = parseInt(this.select.data("limit"))), this.build_and_append_picker()
        }

        return t.prototype.build_and_append_picker = function () {
            return this.opts.hide_select && this.select.hide(), this.select.change({picker: this}, function (t) {
            ...
            var s, l, n, r, o, c, p, h, a, u;
            for (h = t.children("optgroup"), r = 0, c = h.length; c > r; r++)n = h[r], n = jQuery(n), s = jQuery("<ul></ul>"), s.append(jQuery("<li class='group_title'>" + n.attr("label") + "</li>")), i.append(jQuery("<li>").append(s)), this.recursively_parse_option_groups(n, s);
            for (a = function () {
                var i, s, n, r;
                for (n = t.children("option"), r = [], i = 0, s = n.length; s > i; i++)l = n[i], r.push(new e(l, this, this.opts));
                return r
            }.call(this), u = [], o = 0, p = a.length; p > o; o++)l = a[o], this.picker_options.push(l), l.has_image() && u.push(i.append(l.node));
            return u
        ...
        return t.prototype.has_image = function () {
            ...
            return this.picker.toggle(this), null != this.opts.clicked && this.opts.clicked.call(this.picker.select), null != this.opts.selected && this.is_selected() ? this.opts.selected.call(this.picker.select) : void 0
