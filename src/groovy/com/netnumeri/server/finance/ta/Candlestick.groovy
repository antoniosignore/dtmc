...
public class Candlestick {
    ...
    public static Pattern patternCheck(Stock stock, Date date) {
    ...
    public static boolean isShooting_Star(Stock stock, Date date) {
    ...
    public static boolean isRising_Three_Methods(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isMarubozo(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isLong_Shadows(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isHarami(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isHanging_Man(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isGravestone_Doji(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
    ...
    public static boolean isFalling_Three_Methods(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterday = days.geDateBeforeYesterdayDaily();
        Daily dayBeforeBeforeYesterday = days.geDateBeforeBeforeYesterdayDaily();
        Daily dayBeforeBeforeBeforeYesterday = days.geDateBeforeBeforeBeforeYesterdayDaily();
    ...
    public static boolean isEvening_Star(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterday = days.geDateBeforeYesterdayDaily();
    ...
    public static boolean isEvening_Doji_Star(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterday = days.geDateBeforeYesterdayDaily();
    ...
    public static boolean isEngulfing_Pattern_Bullish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
    ...
    public static boolean isEngulfing_Pattern_Bearish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        if (!isWhite(yesterdayDaily)) return false;
    ...
    public static boolean isDragonfly_Doji_Bearish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        if (!isDoji(daily)) return false;
    ...
    public static boolean isDragonfly_Doji_Bullish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        if (!isDoji(daily)) return false;
    ...
    public static boolean isDownside_Tasuki_Gap(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterday = days.geDateBeforeYesterdayDaily();
    ...
    public static boolean isDoji(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        return isDoji(daily);
    }
    ...
    public static boolean isPiercing_Line(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isHarami_Cross(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isMorning_Doji_Star(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isDark_Cloud_Cover(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        ...
        if (!closesBelowMidpoinDateBodyBefore(daily, yesterdayDaily)) return false;
        if (!(daily.getCloseprice() > yesterdayDaily.getOpenprice())) return false;
        return true;
    }

    private static boolean closesBelowMidpoinDateBodyBefore(Daily daily, Daily yesterdayDaily) {
    ...
    public static boolean isInverted_Hammer(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily dayBeforeYesterdayDaily = days.geDateBeforeYesterdayDaily();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
    ...
    public static boolean isMorning_Star(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isLong_Legged_Doji(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    // Long Date: Long Date Candlestick  A long day represents a large price move from open to close,
    // where the length of the candle body is long.
    public static boolean isLong_Day(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isHammer(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isSpinning_Top(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isStars(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isThree_White_Soldiers(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        return true;
    ...
    public static boolean isUpside_Tasuki_Gap(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterday = days.geDateBeforeYesterdayDaily();
    ...
    public static boolean isAbandoned_Baby_Bullish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily dayBeforeYesterdayDaily = days.geDateBeforeYesterdayDaily();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
    ...
    // which is then followed by another gap in the opposite direction.
    // The shadows on the Doji must completely gap below or above the shadows of the first and third day.
    public static boolean isAbandoned_Baby_Bearish(Stock stock, Date date) {
        Days days = new Days(stock, date).invoke();
        Daily daily = days.getDaily();
        Daily yesterdayDaily = days.getYesterdayDaily();
        Daily dayBeforeYesterdayDaily = days.geDateBeforeYesterdayDaily();
    ...
    public static class Days {
        ...
        public Days(Stock stock, Date date) {
            this.stock = stock;
            this.date = date;
        }
        ...
        public Daily geDateBeforeYesterdayDaily() {
            return dayBeforeYesterdayDaily;
        }

        public Daily geDateBeforeBeforeYesterdayDaily() {
            return dayBeforeBeforeYesterdayDaily;
        }

        public Daily geDateBeforeBeforeBeforeYesterdayDaily() {
