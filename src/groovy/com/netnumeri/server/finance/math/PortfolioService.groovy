...
public class PortfolioService {
    ...
    public static Date getFirstDay(Portfolio portfolio) {
    ...
    public static Date getLastDay(Portfolio portfolio) {
        Instrument instrument;
...
//                dao.put(item);
    ...
    public static void invest(Portfolio portfolio, double wealth, Date date) {
...
//                }
    ...
    // Sell everything
    public static Transaction sell(Portfolio portfolio, Instrument instrument, Date date) {
        int amount;
    ...
    public static double getWealth(Portfolio portfolio, int i, Date date) {
...
//            }
    ...
    public static double getWealth(Portfolio portfolio, Date date) {
        double Wealth = 0;
        for (int i = 0; i < portfolio.items.size(); i++) {
...
//    }
    ...
    public static double getPrice(Portfolio portfolio, Date date) {
     ...
     * @param date
     */
    public static double getValue(Portfolio portfolio, Date date) {
        if (date == null) {
    ...
    public static double getReturn(Portfolio portfolio, Date date) {
    ...
    public static double getLogReturn(Portfolio portfolio, Date date) {
    ...
    public static void setModelDate(Portfolio portfolio, int i, Date date) {
...
//    }
    ...
    public static Date getModelDate(Portfolio portfolio, int i) {
