...
public class FinMath {
    ...
    public static double BM(double spot,
                            ...
                            double volatility,
                            double rate) {
        return BM(spot, strike, time, volatility, rate, FinConstants.kCall, 1000);
    }
    ...
    public static double MC(double S, double X, double t, double s,
                            double r) {
        return MC(S, X, t, s, r, FinConstants.kCall, 0x186a0);
    }
    ...
    public static double BS(double S,
                            ...
                            double s,
                            double r) {
        return BS(S, X, t, s, r, FinConstants.kCall);
    }
    ...
    public static double BS(double S,
                            ...
                            double r,
                            int Option) {
        if (Option == FinConstants.kCall || Option == FinConstants.kEuropean || Option == FinConstants.kAmerican) {
            return S * N(d1(S, X, t, s, r)) - X * Math.exp(-r * t) * N(d2(S, X, t, s, r));
        }
        if (Option == FinConstants.kPut || Option == FinConstants.kEuropeanPut || Option == FinConstants.kAmericanPut) {
            return -S * N(-d1(S, X, t, s, r)) + X * Math.exp(-r * t) * N(-d2(S, X, t, s, r));
        } else {
    ...
    public static double Delta(double S, double X, double t, double s,
                               double r) {
        return Delta(S, X, t, s, r, FinConstants.kCall);
    }
    ...
    public static double Theta(double S, double X, double t, double s,
                               double r) {
        return Theta(S, X, t, s, r, FinConstants.kCall);
    }
    ...
    public static double Rho(double S, double X, double t, double s,
                             double r) {
        return Rho(S, X, t, s, r, FinConstants.kCall);
    }
    ...
    public static double ImpliedVolatility(double S, double X, double t, double r,
                                           double P) {
        return ImpliedVolatility(S, X, t, r, P, FinConstants.kCall, FinConstants.kBlackScholes, -1, 0.001D);
    }
    ...
    public static double ImpliedVolatility(double S, double X, double t, double r,
        ...
        if (n == -1) {
            if (Method == FinConstants.kBinomial) {
                n = 100;
            } else if (Method == FinConstants.kMonteCarlo) {
                n = 0x186a0;
            }
        }
        double sMin = 0;
        ...
        while (Math.abs(sMax - sMin) > Eps) {
            s = sMin + (sMax - sMin) / 2D;
            if (Method == FinConstants.kBlackScholes) {
                p = BS(S, X, t, s, r, Option);
            } else if (Method == FinConstants.kBinomial) {
    ...
    public static double Parity(double P, double S, double X, double t,
                                double r, int Option) {
        if (Option == FinConstants.kCall) {
            return P - (S - X * Math.exp(-r * t));
        }
        if (Option == FinConstants.kPut) {
            return P + (S - X * Math.exp(-r * t));
        } else {
            return -1D;
        }
