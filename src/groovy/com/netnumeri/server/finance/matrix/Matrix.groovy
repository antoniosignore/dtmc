...
/**
 * Jama = Java GenericMatrix class. <P> The Java GenericMatrix Class provides the fundamental operations of numerical linear algebra.
 ...
 * Methods for reading and printing matrices are also included.  All the operations in this version of the GenericMatrix Class
 ...
 * five decomposition classes.  These decompositions are accessed by the GenericMatrix class to compute solutions of
 ...
 * vals = {{1.,2.,3},{4.,5.,6.},{7.,8.,10.}}; GenericMatrix A = new GenericMatrix(vals); GenericMatrix b = GenericMatrix.random(3,1); GenericMatrix x =
 * A.solve(b); GenericMatrix r = A.times(x).minus(b); double rnorm = r.normInf(); </PRE></DD> </DL>
 *
...
public class Matrix implements Serializable {
    ...
    /**
     * Clone the GenericMatrix object.
     */
    public Object clone() {
        return this.copy();
    }
     ...
     *
     * @return GenericMatrix elements packed in a one-dimensional array by columns.
     */
     ...
     *
     * @return GenericMatrix elements packed in a one-dimensional array by rows.
     */
    ...
    */
     ...
     *
     * @param B another matrix
     * @return GenericMatrix product, A * B
     * @throws IllegalArgumentException GenericMatrix inner dimensions must agree.
     */
    public Matrix times(Matrix B) {
        if (B.rows != cols) {
            throw new IllegalArgumentException("GenericMatrix inner dimensions must agree.");
        }
    ...
    /**
     * GenericMatrix inverse or pseudoinverse
     *
    ...
    /**
     * GenericMatrix condition (2 norm)
     *
...
//        }
    ...
    private void checkMatrixDimensions(Matrix B) {
        if (B.rows != rows || B.cols != cols) {
            throw new IllegalArgumentException("GenericMatrix dimensions must agree.");
        }
    }
