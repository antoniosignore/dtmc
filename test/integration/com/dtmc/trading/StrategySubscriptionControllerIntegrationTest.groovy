...
class StrategySubscriptionControllerIntegrationTest {
    ...
    @Test
    void testCreate() {
        StrategySubscriptionControllerTest.params.StrategySubscription = []
        //We must type here the required attributes for the class
    ...
    @Test
    void testUpdate() {
        StrategySubscriptionControllerTest.params.StrategySubscription = [id: 1L]
//We need to search for a specific attribute of the class
