...
class StockController {
    ...
    def show() {
        ...
        List<UserIndicators> list = StockUtils.get(stockInstance);
    ...
    def edit() {
        def stockInstance = Stock.get(params.id)
        if (!stockInstance) {
            flash.message = message(code: 'default.not.foulsnd.message', args: [message(code: 'stock.label', default: 'Stock'), params.id])
            redirect(action: "list")
            return
        }
