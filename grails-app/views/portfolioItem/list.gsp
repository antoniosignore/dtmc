...
<body>
<a href="#list-portfolioItem" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-portfolioItem" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="description"
                              title="${message(code: 'portfolioItem.description.label', default: 'Description')}"/>

            <th><g:message code="portfolioItem.instrument.label" default="Instrument"/></th>

            <g:sortableColumn property="name" title="${message(code: 'portfolioItem.name.label', default: 'Name')}"/>
        ...
        <g:each in="${portfolioItemInstanceList}" status="i" var="portfolioItemInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td>${fieldValue(bean: portfolioItemInstance, field: "description")}</td>

                <td>${fieldValue(bean: portfolioItemInstance, field: "instrument")}</td>

                <td>${fieldValue(bean: portfolioItemInstance, field: "name")}</td>
    ...
    <div class="pagination">
        <g:paginate total="${portfolioItemInstanceTotal}"/>
    </div>
</div>
</body>
</html>
