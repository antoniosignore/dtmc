...
<div class="fieldcontain ${hasErrors(bean: portfolioItemInstance, field: 'description', 'error')} ">
    <label for="description">
        <g:message code="portfolioItem.description.label" default="Description"/>

    </label>
    <g:textField name="description" value="${portfolioItemInstance?.description}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: portfolioItemInstance, field: 'instrument', 'error')} required">
    ...
    <g:select id="instrument" name="instrument.id" from="${com.netnumeri.server.finance.finpojo.Instrument.list()}"
              optionKey="id" required="" value="${portfolioItemInstance?.instrument?.id}" class="many-to-one"/>
</div>

<div class="fieldcontain ${hasErrors(bean: portfolioItemInstance, field: 'name', 'error')} ">
    <label for="name">
        <g:message code="portfolioItem.name.label" default="Name"/>

    </label>
    <g:textField name="name" value="${portfolioItemInstance?.name}"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: portfolioItemInstance, field: 'portfolio', 'error')} required">
    ...
    <g:select id="portfolio" name="portfolio.id" from="${com.netnumeri.server.finance.finpojo.Portfolio.list()}"
              optionKey="id" required="" value="${portfolioItemInstance?.portfolio?.id}" class="many-to-one"/>
</div>
