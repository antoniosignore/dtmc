...
<div class="container">
    <div class="navbar">
        <div class="navbar-inner">
            <ul class="nav">
                <li><a class="home" href="${createLink(uri: '/person')}"><g:message code="default.home.label"/></a>
                </li>
    ...
    <a href="#create-stock" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
