    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="action"
                              title="${message(code: 'transaction.action.label', default: 'Action')}"/>
            ...
            <g:sortableColumn property="description"
                              title="${message(code: 'transaction.description.label', default: 'Description')}"/>
        ...
        <g:each in="${transactionInstanceList}" status="i" var="transactionInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${transactionInstance.id}">${fieldValue(bean: transactionInstance, field: "action")}</g:link></td>
