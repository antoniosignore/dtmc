<%@ page import="com.dtmc.club.Club; com.netnumeri.server.finance.finpojo.Portfolio" %>
...
<div class="control-group fieldcontain ${hasErrors(bean: portfolioInstance, field: 'club', 'error')} ">
    ...
    <g:select id="club" name="club.id" from="${Club.list()}" optionKey="id" value="${portfolioInstance?.club?.id}"
...
<div class="control-group fieldcontain ${hasErrors(bean: portfolioInstance, field: 'firstDate', 'error')} ">
    ...
    <g:datePicker name="firstDailyDate" precision="day" value="${portfolioInstance?.firstDailyDate}" default="none"
                  noSelection="['': '']"/>
</div>
...
<div class="control-group fieldcontain ${hasErrors(bean: portfolioInstance, field: 'lastDate', 'error')} ">
    ...
    <g:datePicker name="lastDailyDate" precision="day" value="${portfolioInstance?.lastDailyDate}" default="none"
                  noSelection="['': '']"/>
</div>
