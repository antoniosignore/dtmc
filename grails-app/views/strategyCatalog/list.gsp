<div data-ng-controller="StrategyCatalogCtrl">
    <h1>StrategyCatalog List</h1>
    ...
    <div>
        ...
        <a class="btn btn-primary btn-primary" data-ng-click="newStrategyCatalog()"><span
                class="glyphicon glyphicon-plus"></span><g:message code="default.new.label" args="['strategyCatalog']"
