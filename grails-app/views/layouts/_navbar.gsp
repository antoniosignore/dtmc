        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse" role="navigation">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown controller">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" role="menu" data-ng-controller="UserCtrl"
                        data-ng-init="getAllLocales()">
                        <li ng-repeat="c in locales" ng-bind-html-unsafe="c.value"><a class="fa fa-language icon-color"
                                                                                      title="{{c.text}}"
                                                                                      data-ng-model="lang"
                                                                                      data-ng-click="setLang(c.value)">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown controller">
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark" role="menu">
                        <li>
                            <a class="fa fa-gear icon-color" onclick='window.location.href = "#/updateusername"'
                               title="${message(code: 'default.username.update', default: 'Update Username')}">
                                <g:message code="default.username.update" default="Update Username"/>
                            </a>
                        </li>
                        <li>
                            <a class="fa fa-gear icon-color" onclick='window.location.href = "#/updatepassword"'
                               title="${message(code: 'default.password.update', default: 'Update password')}">
