<div data-ng-controller="EntryCtrl">
    <h1>Entry List</h1>
    ...
    <div>
        ...
        <a class="btn btn-primary btn-primary" data-ng-click="newEntry()"><span
                class="glyphicon glyphicon-plus"></span><g:message code="default.new.label" args="['entry']"
                                                                   default="New entry"/></a>
            ...
            <div>
                ...
                <div loading-container="tableParams.settings().$loading">
                    <table class="table" ng-table="tableParams" show-filter="true">
                        <tr data-ng-repeat="instance in entrys" data-ng-click="editEntry(instance)">
